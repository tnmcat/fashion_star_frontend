                ...
                <div className="w-full h-full bg-white px-4 col-span-4 pb-3">
                    {products.length > 0 ? (
                        <div className="font-titleFont flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
                            ...
                            <h4 className="sm:text-md lg:text-xl font-normal">
                                Subtotal
                            </h4>
                        </div>
                    ) : (
                    ...
                    {products.length > 0 ? (
                        ...
                        >
                            ...
                            <div className="sm:w-36 md:w-52 lg:w-96 sm:p-2 lg:p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
                                ...
                                <Link to="/">
                                    <button
                                        className="mt-6 w-auto text-white bg-indigo-600 rounded-md cursor-pointer hover:bg-indigo-500 active:bg-indigo-700
                                     px-8 py-2 font-titleFont font-semibold sm:text-xs dm:text-md lg:text-lg"
                                    >
                                        <ShoppingCartCheckoutIcon /> Continue
                                        Shopping
                                    </button>
                                </Link>
                            </div>
