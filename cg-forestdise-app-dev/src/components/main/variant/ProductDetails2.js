                ...
                {selectedVariant && (
                    ...
                    border-zinc-400 active:border-yellow-800 active:shadow-amazonInput duration-100 cursor-pointer"
                                        ...
                                        <>
                                            ...
                                            <button
                                                className="rounded-lg  bg-indigo-600 py-3 my-2 hover:bg-indigo-600 text-amazon_white duration-100 cursor-pointer opacity-25"
                                                disabled
                                            >
                                                Add To Cart
                                            </button>
                            ...
                            {reviewAnalyst && (
                                <div className="w-full h-full col-span-2 flex flex-col py-4 border-gray-300 text-bodyFont">
                                    ...
                                    <div className="flex flex-row h-full item-center justify-start mt-4 mb-4">
                                        ...
                                        >
                                            How customer reviews and ratings
                                            work?
                                        </span>
                                    </div>
                                    {showRecommend && (
                                        <div className="flex flex-col w-10/12 text-start pl-3 font-titleFont text-sm pb-4">
                                            ...
                                            <br></br>
                                            <span>
                                                To calculate the overall star
                                                rating and percentage breakdown
                                                by star, we don’t use a simple
                                                average. Instead, our system
                                                considers things like how recent
                                                a review is and if the reviewer
                                                bought the item on Fashion star.
                                                It also analyzed reviews to
