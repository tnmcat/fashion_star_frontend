...
function Product() {
    ...
    const onSubmit = async (data) => {
        ...
        dispatch(
            addProduct({
                ...
                storeCategoryId: selectedYourCate.id,
            })
        );
    ...
    const handleSelectChange = (event) => {
        ...
        const selectedObject = storecategories.find(
    ...
    return (
        <div className="col-span-8  border-2 border-gray-500 p-4 text-titleFont ml-20 mr-20 rounded-xl">
            <span className="text-sm text-titleFont text-left">
                {" "}
                All Department &gt;&gt;&gt; {category.attribute}
            </span>
            <form className="items-center" onSubmit={handleSubmit(onSubmit)}>
                <div className="grid grid-cols-2">
                    <div className="col-span-1 mr-4">
                        <div className="text-titleFont mt-5">
                            <label
                                htmlFor="title"
                                className="mb-2 text-sm font-medium text-gray-900 dark:text-gray mt-5"
                            >
                                Title
                            </label>
                            <br></br>
                        ...
                        <div className="text-titleFont mt-5">
                            ...
                            {firebaseFile && (
                                <img
                                    alt="hihi"
                                    src={firebaseFile}
                                    className="rounded-3xl w-30 h-30 mt-10"
                                />
                            )}
                            {!firebaseFile && (
                                <div className="outerbar">
                                    <div className="innerbar text-titleFont">
                                        {progresspercent}%
                                    </div>
                                </div>
                            )}
                    ...
                    <div className="col-span-1 ">
                        {storecategories ? (
                            <div>
                                <label
                                    htmlFor="category"
                                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray mt-4"
                                >
                        ...
                        <div className="text-titleFont mt-5">
                            <label className="mb-2 text-sm font-medium text-gray-900 dark:text-gray mt-5">
                                Shop Id
                            </label>
                            <br></br>
                ...
                <div className="text-center">
                    <button
                        type="submit"
                        className="w-30 h-30 bg-amazon_blue text-xl text-white px-10 rounded-2xl mt-5"
                    >
                        Next
                    </button>
                </div>
