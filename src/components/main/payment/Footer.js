    ...
    return (
        <div className="flex flex-col text-sm py-5 px-20">
            <div class="border-t border-gray-400 py-3">
                ...
                <span className="py-2 text-xs">
                    For an item sold by FashionStar : When you click the "Place
                ...
                <span className="py-2 text-xs">
                    All items in this order are sold by FashionStar Export Sales
                    LLC (AES), unless otherwise noted. By placing your order,
                    you authorize AES to designate a carrier to clear the
                    package and pay the import fees on your (or the recipient's)
                    behalf. Customs declarations will be made in the name and on
                    the behalf of your (or the recipient's) behalf by the
                    designated carrier. You can find the complete terms and
                ...
                <span className="py-2 text-xs">
                    ...
                    restrictions apply. See FashionStar 's Returns Policy.
                </span>
                <span className="py-2 text-xs">
